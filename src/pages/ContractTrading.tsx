...
const ContractTrading = () => {
  ...
  const margin = selectedContract
    ? (selectedContract.price * 300 * leverage * parseFloat(tradeAmount || '0')) / 10000
    : 0;
  const pnl = selectedContract
    ? selectedContract.price * 300 * parseFloat(tradeAmount || '0') * 0.01
    : 0;
