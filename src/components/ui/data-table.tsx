...
>(({ className, ...props }, ref) => (
  <TableTheme.Root ref={ref} className={cn('w-full', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <TableTheme.Header ref={ref} className={cn('[&_tr]:border-b', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <TableTheme.Body ref={ref} className={cn('[&_tr:last-child]:border-0', className)} {...props} />
));
