...
import { Table, TableHeader, TableBody, TableHead, TableRow, TableCell } from './ui/data-table';
    ...
    <div className="p-6 bg-gray-900 rounded-lg">
      ...
      <div className="mt-6 p-4 bg-gray-800 rounded-lg">
        ...
        <ul className="text-gray-300 text-sm list-disc pl-5 space-y-1">
          ...
          <li>
            在项目中可以通过以下方式导入：import {'{'} Table, TableHeader, TableBody, TableHead,
            TableRow, TableCell {'}'} from './ui/data-table'
          </li>
        </ul>
      </div>
    </div>
